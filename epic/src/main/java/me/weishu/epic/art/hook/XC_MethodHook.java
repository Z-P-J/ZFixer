...
public abstract class XC_MethodHook extends XCallback {
     ...
     *
     * <p>You can use {@link XC_MethodHook.MethodHookParam#setResult} and {@link XC_MethodHook.MethodHookParam#setThrowable}
    ...
    public class Unhook implements IXUnhook<XC_MethodHook> {
        ...
        @Override
        public void unhook() {
            HookManager.unhookMethod(hookMethod, XC_MethodHook.this);
        }
