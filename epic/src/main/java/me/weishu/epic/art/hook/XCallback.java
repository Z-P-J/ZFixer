...
public abstract class XCallback implements Comparable<XCallback> {
    ...
    public static abstract class Param {
        ...
        /** @hide */
        protected Param(HookManager.CopyOnWriteSortedSet<? extends XCallback> callbacks) {
        ...
        public Object getObjectExtra(String key) {
            ...
            if (o instanceof XCallback.Param.SerializeWrapper)
                return ((XCallback.Param.SerializeWrapper) o).object;
            return null;
        }
        ...
        public void setObjectExtra(String key, Object o) {
            getExtra().putSerializable(key, new XCallback.Param.SerializeWrapper(o));
        }
